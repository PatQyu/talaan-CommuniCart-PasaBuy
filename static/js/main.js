...
async function submitGroceryForm(event) {
    ...
    // Payload updated to map cleanly to your layout sections without breaking
    const payload = {
...
window.initMap = function initMap() {
    ...
    mapInstance = new google.maps.Map(mapEl, {
        center: { lat: 14.5995, lng: 120.9842 }, // Default coordinates
        zoom: 11,
...
// Event Binding Hook initializations
if (groceryForm) {
...
// Fallback configuration error validation messaging alerts
...
// Initial empty slate rendering block instantiation
renderReceipt([]);